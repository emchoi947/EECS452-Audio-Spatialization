...
Written by Seohyeon Choi and Alex Shamoun
*

Description:

This header file contains the implementation of the ADPCM decoding algorithm, 
which is used to convert compressed audio data back into its original PCM format.
